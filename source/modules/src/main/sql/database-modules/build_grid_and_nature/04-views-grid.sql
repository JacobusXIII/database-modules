 ...
 * See {@link grid.ae_determine_habitat_coverage_on_hexagon} for the calculation method.
 */
...
SELECT
	...
	receptor_id,
	surface,
	grid.ae_determine_habitat_coverage_on_hexagon(assessment_area_id, type, critical_deposition_area_id, receptor_id) AS receptor_habitat_coverage
